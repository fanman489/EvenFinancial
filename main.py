...
cat_vars = ['loan_purpose', 'lender_id', 'credit']



"""Select query to combine the three tables into one."""
select_query = "SELECT leads.index, leads.lead_uuid, leads.credit, leads.requested, leads.loan_purpose, leads.annual_income,\
